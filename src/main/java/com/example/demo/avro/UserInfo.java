...
public class UserInfo extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6311453704779603348L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserInfo\",\"namespace\":\"com.example.demo.avro\",\"fields\":[{\"name\":\"username\",\"type\":\"string\"},{\"name\":\"firstName\",\"type\":\"string\"},{\"name\":\"lastName\",\"type\":\"string\"}]}");
   ...
   */
  public static com.example.demo.avro.UserInfo.Builder newBuilder() {
    return new com.example.demo.avro.UserInfo.Builder();
  }
   ...
   * @return A new UserInfo RecordBuilder
   */
  public static com.example.demo.avro.UserInfo.Builder newBuilder(com.example.demo.avro.UserInfo.Builder other) {
    if (other == null) {
      return new com.example.demo.avro.UserInfo.Builder();
    } else {
      return new com.example.demo.avro.UserInfo.Builder(other);
    }
  }
   ...
   * @return A new UserInfo RecordBuilder
   */
  public static com.example.demo.avro.UserInfo.Builder newBuilder(com.example.demo.avro.UserInfo other) {
    if (other == null) {
      return new com.example.demo.avro.UserInfo.Builder();
    } else {
      return new com.example.demo.avro.UserInfo.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserInfo>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.demo.avro.UserInfo.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.demo.avro.UserInfo other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.username)) {
        this.username = data().deepCopy(fields()[0].schema(), other.username);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.avro.UserInfo.Builder setUsername(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.avro.UserInfo.Builder clearUsername() {
      username = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.avro.UserInfo.Builder setFirstName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.avro.UserInfo.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.avro.UserInfo.Builder setLastName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.avro.UserInfo.Builder clearLastName() {
      lastName = null;
